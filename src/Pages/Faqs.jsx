...
const Faqs = () => {
  ...
  return (
    <Box  pl="20px" pr="20px">
        <Flex gap="10px">
            <Box w='300px'  >
                <Box pt="10px" mb="3px" fontSize='xs' bg="#f1f1f1" h="40px" ><a href="#data1"><Center>About Revv</Center></a></Box>
                <Box bg="#f1f1f1" pt="10px" mb="3px" fontSize='xs' h="40px"  ><a href="#about"><Center>Your Booking</Center></a></Box>
                <Box bg="#f1f1f1" pt="10px" mb="3px" h="40px" fontSize='xs'><Center>Payment & Refunds</Center></Box>
                <Box bg="#f1f1f1"pt="10px" h="40px" fontSize='xs'><Center>Your Trip</Center></Box>
                </Box>
  ...
  <AccordionItem mb="10px">
    ...
    <AccordionPanel bg="#f1f1f1" boxShadow='base' fontSize='sm' color='#7f868e'>
