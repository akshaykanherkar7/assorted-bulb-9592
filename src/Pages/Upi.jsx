...
const Upi = () => {
  ...
  return (
    <Container
      ...
      className={styled.contan}
    >
      <Box className={styled.header}>
        <img
          className={styled.imglog}
          src="https://cdn.razorpay.com/logos/EM3w4wVw6CAP6s_medium.png"
          alt=""
        />
      </Box>
      ...
      <form onSubmit={handleFormSubmit}>
        <Box className={styled.contanUpi}>
          <Box className={styled.contanUpiChildBox}>
            ...
            <Spacer className={styled.UpiPaymentspan}>
              You can create your VPA from any UPI app like Google Pay, PhonePe,
              BHIM etc.
            </Spacer>
            <Input
              className={styled.inputUpi}
              placeholder="Your VPA (someone@abc)"
              required
            />
          </Box>
      ...
      <Box className={styled.scanheading}>
        ...
        <Box className={styled.scanBox}>
          <Button className={styled.scanBtn}>
            <h3>Show QR Code</h3>
            <span className={styled.spanScanBox}>
