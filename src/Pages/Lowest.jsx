...
import { Box, color, SimpleGrid, Text } from "@chakra-ui/react";
      ...
      <Box width="98%" margin="auto">
        ...
        <Box>
          <ul className={styles.ul}>
            ...
            encompasses all the preventive hygiene best practices directed by
        ...
        <Box>
          <ul className={styles.ul}>
            ...
            car rental options to drive down to the nearby beach or to manoeuvre
            through traffic as you head from one important business meeting to
            the next. With a self-drive car rental from Revv, you have the
            freedom to move around and explore places at your own pace.
          </ul>
        </Box>
        <Box p="4">
          <Text
        ...
        <Box>
          <ul className={styles.ul}>
            ...
            Brezza, Ford EcoSport, Mahindra Scorpio, Toyota Innova Crysta,
            Mahindra XUV and many other car models that suit your requirement.
          </ul>
        </Box>
        <Box p="4">
          <Text
        ...
        <Box>
          <ul className={styles.ul}>
            ...
            Trivandrum, Tirupati, Vijayawada, Vizag, Bhubaneswar, Nagpur &
            Vadodara.
          </ul>
        </Box>
        <Box p="4">
